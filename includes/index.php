                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="investment">
                            <?php echo __('Monthly investment amount', ' sip-calculator'); ?>:</label>
                        <input type="number" id="investment_amount" name="investment" pattern="[0-9]+"
                            title="<?php echo __('please enter number only', ' sip-calculator'); ?>"
                            value="<?php echo esc_attr($a['invested_amount_monthly']); ?>" class="form-control">

                    </div>
                    <div class="form-group">
                        <label for="return">
                            <?php echo __('Expected return rate (in percentage)', ' sip-calculator'); ?>:</label>
                        <input type="number" id="return_rate" name="return rate" pattern="[0-9]+"
                            title="<?php echo __('please enter number only', ' sip-calculator'); ?>"
            ...
            success: function(data) {
                ...
                function drawChart() {
                    var data = google.visualization.arrayToDataTable([
                        ['<?php echo __('Task', ' sip-calculator'); ?>',
                            '<?php echo __('invested amount', ' sip-calculator'); ?>'
                        ],
                        ['<?php echo __('Invested amount', ' sip-calculator'); ?>',
                            invested_amount
                        ],
                        ['<?php echo __('Estimated Gain amount', ' sip-calculator'); ?>',
                            est_return
                        ],
                        ['<?php echo __('Total amount', ' sip-calculator'); ?>',
                            total_value
                        ],
                    ]);
